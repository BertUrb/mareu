...
public abstract class DummyMeetingGenerator {
    public static List<Meeting> DUMMY_MEETINGS = Arrays.asList(
            new Meeting("14:00","3/12/2021","Réunion A",Arrays.asList("maxime@lamzone.com","luc@lamzone.com","paul@lamzone.com"),"Mario", Color.CYAN),
            new Meeting("15:00","2/12/2021","Réunion B",Arrays.asList("elise@lamzone.com","luc@lamzone.com","jo@lamzone.com"),"Luigi", Color.MAGENTA),
